	...
	public static void main(String[] args) {
		...
		try {
			//Step 1: Initialize the driver and connect to a SQL server
	 		 ...
	 		 try {
	 			 conn = DriverManager
	 					 .getConnection("jdbc:mysql://localhost:8899/mysql?"
			 ...
			 sql = "DROP TABLE IF EXISTS USER_CATEGORY_HISTORY";
	  		...
	  		//Step 3: insert data
	  		 BufferedReader reader = new BufferedReader(new FileReader(
	  				 "C:/Users/CH/Desktop/IT/Laioffer/Project/yelp_dataset_challenge_academic_dataset/yelp_dataset_challenge_academic_dataset/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json"));
	  		 /*int count = 0;*/
